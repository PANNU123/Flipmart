    ...
    @enderror
        <div class="panel  b-primary bt-md">
            <div class="panel-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form class="form-horizontal" method="POST" action="{{route('update-division')}}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <input type="text" class="form-control" value="{{$division->division_name}}" id="division_name" name="division_name" placeholder="Division name" data-validation="required">
                                </div>
                            </div>
